...
Mechanized proofs of safety and liveness properties for the [Gasper protocol](https://arxiv.org/abs/2003.03052) (Casper FFG + LMD GHOST), ported from [Coq](https://github.com/banr1/tailored-beacon-chain-verification/tree/master/casper/coq) to Lean 4 with mathlib4.
